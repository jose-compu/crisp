...
- **Closures / lambdas** (`|x| …`, spec §5.3): parsed / partially typed; **not** emitted end-to-end. First-class function values + lexical capture planned for v1.6.0 ([#72](https://github.com/jose-compu/crisp/issues/72)).

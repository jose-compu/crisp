...
- **Closures / function values** (spec §5.2–§5.3): design target is **one** callable kind (closure); naming optional. Parsed / partially typed today; **not** emitted end-to-end — [#72](https://github.com/jose-compu/crisp/issues/72) (**v1.7.0**).

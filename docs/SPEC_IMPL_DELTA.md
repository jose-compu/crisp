...
| User generics | §3 / §5 | Type / function / trait params + applications (`examples/generics`) — [#71](https://github.com/jose-compu/crisp/issues/71); free names as binders (`examples/generics_implicit`) — [#75](https://github.com/jose-compu/crisp/issues/75); inferred `impl Trait for Type` args + `+` bounds on params — [#77](https://github.com/jose-compu/crisp/issues/77); `where` / crate-wide generalization still limited ([#76](https://github.com/jose-compu/crisp/issues/76)) |

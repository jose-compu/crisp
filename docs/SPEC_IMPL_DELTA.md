...
| Shapes | §3.5 | Data shapes + parametric `shape Name<T>` (`examples/shapes`, `examples/generics`); method/anonymous shapes still limited ([#61](https://github.com/jose-compu/crisp/issues/61), [#70](https://github.com/jose-compu/crisp/issues/70)) |
| User generics | §3 / §5 | Type / function / trait params + applications end-to-end (`examples/generics`) — [#71](https://github.com/jose-compu/crisp/issues/71); `where` / rich bounds still limited |

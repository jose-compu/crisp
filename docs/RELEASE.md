...
| Artifact | Policy |
|----------|--------|
| Workspace crates / `crisp` | Semver in root `Cargo.toml` (`1.7.0` today) |
...
**crates.io:** publish **v1.7.0** via [#66](https://github.com/jose-compu/crisp/issues/66). Procedure and publish order: [CRATES_IO.md](CRATES_IO.md).

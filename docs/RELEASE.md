...
| Artifact | Policy |
|----------|--------|
| Workspace crates / `crisp` | Semver in root `Cargo.toml` (`1.5.2` today) |
...
**crates.io:** first public registry publish tracked in [#66](https://github.com/jose-compu/crisp/issues/66) (v1.5.2). Procedure and publish order: [CRATES_IO.md](CRATES_IO.md). Prior deferral: [#60](https://github.com/jose-compu/crisp/issues/60).

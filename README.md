...
[![Version](https://img.shields.io/badge/version-1.7.0-0A66C2.svg)](CHANGELOG.md)
...
**Milestone:** [v1.7.0](https://github.com/jose-compu/crisp/milestones)
...
**v1.7.0** — first-class function values and implicit-closure sugar (`examples/closures`, #72 / #87–#89).

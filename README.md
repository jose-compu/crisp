...
[![Version](https://img.shields.io/badge/version-1.9.0-0A66C2.svg)](CHANGELOG.md)
...
**Milestone:** [v1.9.0](https://github.com/jose-compu/crisp/milestones)
...
**v1.9.0** — `extern rust` `vec<float>` / `vec<int>` (#153); OS prelude `env_*` / `path_*` / `fs_write` (#151); `src/lib.crp` emits Cargo `[lib]` (#152). v1.8.x language features remain.
